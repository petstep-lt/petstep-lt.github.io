  ...
  (e, t, r) => {
    ...
    function s(t) {
      for (var r = t[1], n = [], o = 0; o < r.length; o++) {
        var s = e.L(r[o]);
        if ((i.has(s) || n.push(s), !a.has(s))) {
          var c = i.add.bind(i, s);
          (s.then(c, l), a.add(s));
        }
      }
      return 4 === t.length
    ...
    function D(e, t) {
      ((e._closed = !0),
        ...
        e._chunks.forEach(function (r) {
          "pending" === r.status && P(e, r, t);
        }));
    }
    function I(e) {
      return { $$typeof: p, _payload: e, _init: O };
    }
    function $(e, t) {
      var r = e._chunks,
        n = r.get(t);
    ...
    function F(e, t) {
      ...
      ((e = e.response),
        r.errored ||
          ...
          (r.value = null),
          (r.reason = t),
          null !== (r = r.chunk) && "blocked" === r.status && P(e, r, t)));
    }
        ...
        u.then(
          ...
          function (t) {
            if (!a.errored) {
              ...
              var r = a.chunk;
              null !== r && "blocked" === r.status && P(e, r, t);
            }
          },
        ),
        null
          ...
          for (var a = 1; a < t.length; a++) {
            for (; "object" == typeof u && null !== u && u.$$typeof === p; ) {
              ...
              switch (u.status) {
                ...
                case "blocked":
                case "pending":
                  return x(u, r, n, e, o, t.slice(a - 1));
                case "halted":
                  return (
                    k
                      ? ((e = k), e.deps++)
            ...
            if ("string" == typeof t) {
              ...
              if ("$" === u[0]) {
                ...
                switch (u[1]) {
                  ...
                  case "W":
                    return H(r, (u = u.slice(2)), n, o, Y);
                  case "B":
                    return H(r, (u = u.slice(2)), n, o, W);
                  case "K":
                    return H(r, (u = u.slice(2)), n, o, K);
                  case "Z":
                    return er();
                  case "i":
    ...
    function et(e, t, r) {
      ...
      ((a[v] = function () {
        ...
        Q(e, t, r ? a[v]() : a, {
          ...
          enqueueModel: function (t) {
            (u === n.length ? (n[u] = j(e, t, !1)) : A(e, n[u], t, !1), u++);
          },
          close: function (t) {
            for (
              o = !0,
                u === n.length ? (n[u] = j(e, t, !0)) : A(e, n[u], t, !0),
                u++;
              u < n.length;
            )
              A(e, n[u++], '"$undefined"', !0);
    ...
    function ei(e, t, r) {
      ...
      a.read()
        .then(function t(i) {
          ...
          i = u._rowID;
          for (
            var p = u._rowTag, h = u._rowLength, v = u._buffer, _ = l.length;
            c < _;
          ) {
            var y = -1;
            switch (d) {
            ...
            if (-1 < y)
                  ...
                  case 73:
                    ...
                    if ((p = s(_))) {
                      if (v) {
                        var y = v;
                        y.status = "blocked";
                      } else ((y = new E("blocked", null, null)), h.set(d, y));
                      p.then(
                        function () {
                          return N(c, y, _);
                        },
                      ...
                      v
                        ? N(c, v, _)
                        : ((v = new E("resolved_module", _, null)),
                          h.set(d, v));
                    break;
                  case 72:
                    switch (
              ...
              })(e, u, i, p, v, (h = new Uint8Array(l.buffer, g, y - c))),
                (c = y),
                3 === d && c++,
                (h = i = p = d = 0),
                (v.length = 0));
            else {
              ((l = new Uint8Array(l.buffer, g, l.byteLength - c)),
                v.push(l),
                (h -= l.byteLength));
              break;
            }
    ...
    ((r.createFromFetch = function (e, t) {
      ...
      (r.createFromReadableStream = function (e, t) {
        return (ei((t = ea(t)), e, eu.bind(null, t)), $(t, 0));
      }),
    ...
    async function b(e, t) {
      ...
      try {
        ...
        let r = await m(e, u, t, !0, g.signal),
          ...
          v = !!r.headers.get(i.NEXT_DID_POSTPONE_HEADER),
          _ = r.headers.get(i.NEXT_ROUTER_STALE_TIME_HEADER),
          b = null !== _ ? 1e3 * parseInt(_, 10) : -1,
          O = s.startsWith(i.RSC_CONTENT_TYPE_HEADER);
        if ((O || (O = s.startsWith("text/plain")), !O || !r.ok || !r.body))
          return (e.hash && (n.hash = e.hash), y(n.toString()));
        let R = r.flightResponse;
        if (null === R) {
          let e,
            t = v
              ? ((e = r.body.getReader()),
        ...
        let S = await R;
        if ((0, d.getAppBuildId)() !== S.b) return y(r.url);
        let T = (0, f.normalizeFlightData)(S.f);
